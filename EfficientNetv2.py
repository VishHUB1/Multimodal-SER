...
def emotion_classification(
    ...
    # Transformations - EfficientNetV2 recommended size is 224x224
    transform = transforms.Compose([
        transforms.Resize((224, 224)),  # EfficientNetV2 recommended size
        transforms.ToTensor(),
    ...
    # Model setup - using EfficientNetV2-S
    model = torchvision.models.efficientnet_v2_s(weights='DEFAULT')
    # Modify the final classifier
    model.classifier = torch.nn.Sequential(
        torch.nn.Dropout(p=0.2, inplace=True),
        torch.nn.Linear(in_features=1280, out_features=6)  # 6 emotion classes
    )
...
if __name__ == '__main__':
    model = emotion_classification(
        ...
        learning_curves_path=r"C:\Users\visha\Desktop\SER\Results_mel\EfficientNet",
        confusion_matrix_path=r"C:\Users\visha\Desktop\SER\Results_mel\EfficientNet",
        classification_report_path=r"C:\Users\visha\Desktop\SER\Results_mel\EfficientNet"
    )
