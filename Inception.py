    ...
    for epoch in range(num_epochs):
        ...
        for images, labels in train_loader:
            ...
            if isinstance(outputs, tuple):
                outputs = outputs.logits  # Get the main output
...
if __name__ == '__main__':
    model = emotion_classification(
        root_dir=r"D:\Academics\Projects\SER\Features\CremaD_Mel",
        learning_curves_path=r"D:\Academics\Projects\SER\Results_mel\Inception",
        confusion_matrix_path=r"D:\Academics\Projects\SER\Results_mel\Inception",
        classification_report_path=r"D:\Academics\Projects\SER\Results_mel\Inception"
    )